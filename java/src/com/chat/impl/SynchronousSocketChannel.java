 ...
 */
public class SynchronousSocketChannel implements BinaryStream {
    ...
    public SynchronousSocketChannel(SocketChannel socket) throws IOException {
        channel = socket;
        channel.configureBlocking(true);
        input = ByteBuffer.allocateDirect(10 * 1024);
    ...
    public void startReading() throws IOException {
        readSync(2);
        short messageBytes = input.getShort();
        readSync(messageBytes);
    }
