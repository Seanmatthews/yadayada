...
public class ChatroomMessage implements Message {
    ...
    public ChatroomMessage(long chatroomId, long chatroomOwnerId, String chatroomName, String chatroomOwnerHandle,
                           long latitude, long longitude, long radius, int userCount, short chatActivity, byte isPrivate) {
