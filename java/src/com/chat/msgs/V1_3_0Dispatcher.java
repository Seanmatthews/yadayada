 ...
 */
public class V1_3_0Dispatcher implements MessageDispatcher {
    ...
    public V1_3_0Dispatcher(ChatServer server, UserRepository userRepo, ChatroomRepository chatroomRepo) {
        this.server = server;
        ...
        switch (type) {
            ...
            case Register:
                ...
                server.registerUser(stream, rMsg.getUserName(), rMsg.getPassword(), rMsg.getHandle(),
                        rMsg.getUUID(), rMsg.getPhoneNumber(), "");
                break;
