...
- (id)init
{
    ...
    if (self) {
        ...
        _joinedChatroomDicts = [[NSUserDefaults standardUserDefaults] objectForKey:@"JoinedChatroomDictionaries"];
...
+ (void)save
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:ud.joinedChatroomDicts forKey:@"JoinedChatroomDictionaries"];
